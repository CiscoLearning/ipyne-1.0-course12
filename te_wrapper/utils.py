...
# TASK 3: Utility functions for common workflows
# Uncomment the ThousandEyesUtils class below to implement utility functions
'''
class ThousandEyesUtils:
    ...
    def create_and_run_test(self, test_name: str, target_url: str, 
                           wait_for_results: bool = True) -> Optional[Dict[str, Any]]:
        """
